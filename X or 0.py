...
winnig_combination = [(0,1,2), (3,4,5),(6,7,8),(0,3,8),(1,4,7),(2,5,8),(0,4,8),(2,4,6)]
...
def play_game(board):
	current_sign ='X'
	while get_winner(board,winnig_combination)=="":
		index = int(input(f'Where do you want to draw {current_sign}'))
		board[index] = current_sign

		print_state(board)

		winner_sign = get_winner(board,winnig_combination)
		if winner_sign !='':
